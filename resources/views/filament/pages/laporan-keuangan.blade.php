                ...
                <tbody>
                    @foreach($orders as $order)
                        <tr class="border-b bg-gray-50 text-gray-900 dark:bg-gray-700 dark:text-white">
                            ...
                            <td class="p-3 text-center">{{ \Carbon\Carbon::parse($order->order_date)->format('Y-m-d') }}</td>
                        ...
                        <tr id="details-{{ $order->id }}" class="hidden">
                            <td colspan="6" class="p-3 bg-gray-200 text-gray-900 dark:bg-gray-900 dark:text-white">
